...
function defHdrStyle() {
	...
	dvHdr.style.width='460px';
	dvHdr.style.fontFamily='tahoma';
	dvHdr.style.border='1px solid #FECB00';
	dvHdr.style.padding='4px';
	dvHdr.style.fontSize='12px';
	dvHdr.style.color='#FFFFFF';
	dvHdr.style.textShadow='-1px -1px 0 #111111';
	dvHdr.style.background='#FECB00';
	dvHdr.style.filter='alpha(opacity=85)'; // IE
	dvHdr.style.opacity='0.95'; // FF
}

function defBdyStyle() {
	dvBdy.style.borderBottom='1px solid #FECB00';
	dvBdy.style.borderLeft='1px solid #FECB00';
	dvBdy.style.borderRight='1px solid #FECB00';
	dvBdy.style.width='460px';
