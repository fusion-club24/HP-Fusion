...
define("DB_BBCODES_RIGHTSGROUPS", DB_PREFIX."bbcodes_rightsgroups");
define("DB_BBCODES_RIGHTSUSERS", DB_PREFIX."bbcode_rightsusers");
...
define("DB_USER_DELLOG", DB_PREFIX."user_dellog");
...
define("DB_USERS_BLOCKS", DB_PREFIX."users_blocks");
