...
$icon = "<img src='".IMAGES."user_fields/skype.png' width='24' alt='' style='vertical-align: middle;'>";
...
if ($profile_method == "input") {
	...
	echo "<tr>\n";
	echo "<td class='tbl".$this->getErrorClass("user_skype")."'><label for='user_skype'>".$icon." ".$locale['uf_skype'].$required."</label></td>\n";
...
// Display in profile
	...
	if ($user_data['user_skype']) {
		echo "<tr>\n";
		echo "<td class='tbl1'>".$icon." ".$locale['uf_skype']."</td>\n";
