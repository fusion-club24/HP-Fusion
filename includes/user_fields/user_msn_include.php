...
$icon = "<img src='".IMAGES."user_fields/msn.png' width='24' alt='' style='vertical-align: middle;'>";
...
if ($profile_method == "input") {
	...
	echo "<tr>\n";
	echo "<td class='tbl".$this->getErrorClass("user_msn")."'><label for='user_msn'>".$icon." ".$locale['uf_msn'].$required."</label></td>\n";
...
// Display in profile
	...
	if ($user_data['user_msn']) {
		echo "<tr>\n";
		echo "<td class='tbl1'>".$icon." ".$locale['uf_msn']."</td>\n";
