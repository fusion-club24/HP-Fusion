...
$icon = "<img src='".IMAGES."user_fields/yahoo.png' width='24' alt='' style='vertical-align: middle;'>";
...
if ($profile_method == "input") {
	...
	echo "<tr>\n";
	echo "<td class='tbl".$this->getErrorClass("user_yahoo")."'><label for='user_yahoo'>".$icon." ".$locale['uf_yahoo'].$required."</label></td>\n";
...
// Display in profile
	...
	if ($user_data['user_yahoo']) {
		echo "<tr>\n";
		echo "<td class='tbl1'>".$icon." ".$locale['uf_yahoo']."</td>\n";
