...
$icon = "<img src='".IMAGES."user_fields/icq.png' width='24' alt='' style='vertical-align: middle;'>";
...
if ($profile_method == "input") {
	...
	echo "<tr>\n";
	echo "<td class='tbl".$this->getErrorClass("user_icq")."'><label for='user_icq'>".$icon." ".$locale['uf_icq'].$required."</label></td>\n";
...
// Display in profile
	...
	if ($user_data['user_icq']) {
		echo "<tr>\n";
		echo "<td class='tbl1'>".$icon." ".$locale['uf_icq']."</td>\n";
