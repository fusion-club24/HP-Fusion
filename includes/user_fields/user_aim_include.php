...
$icon = "<img src='".IMAGES."user_fields/aim.png' width='24' alt='' style='vertical-align: middle;'>";
...
if ($profile_method == "input") {
	...
	echo "<tr>\n";
	echo "<td class='tbl".$this->getErrorClass("user_aim")."'><label for='user_aim'>".$icon." ".$locale['uf_aim'].$required."</label></td>\n";
...
// Display in profile
	...
	if ($user_data['user_aim']) {
		echo "<tr>\n";
		echo "<td class='tbl1'>".$icon." ".$locale['uf_aim']."</td>\n";
