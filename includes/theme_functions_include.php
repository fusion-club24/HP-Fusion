...
function showcopyright($class = "", $nobreak = false) {
	$link_class = $class ? " class='$class' " : "";
	$res = "<a href='https://harlekin-power.de'".$link_class.">HP-Fusion</a> based on <a href='https://www.php-fusion.co.uk'".$link_class.">PHP-Fusion</a> &copy; ".date("Y")." Released under <a href='http://www.fsf.org/licensing/licenses/agpl-3.0.html'".$link_class.">GNU Affero GPL</a> v3\n";
	return $res;
}
