...
if ($_GET['stype'] == "l") {
	if (isset($_POST['submit_link'])) {
		...
		if (dbrows($result)) {
			...
			echo "<td class='tbl'><textarea name='link_description' cols='50' rows='15' class='textbox' style='width:300px'></textarea></td>\n";
			echo "</tr>\n<tr>\n";
	...
	if (isset($_POST['submit_news'])) {
		if ($_POST['news_subject'] != "" && $_POST['news_body'] != "") {
			...
			$submit_info['news_snippet'] = stripinput($_POST['news_snippet']);
			$submit_info['news_body'] = stripinput($_POST['news_body']);
		...
		if (isset($_POST['preview_news'])) {
			...
			echo $locale['478']." ".stripslashes(nl2br(parsesmileys(parseubb($news_snippet))))."<br /><br />";
			echo $locale['472']." ".stripslashes(nl2br(parsesmileys(parseubb($news_body))));
			closetable();
		}
		if (!isset($_POST['preview_news'])) {
			$news_subject = "";
	...
	if (isset($_POST['submit_article'])) {
		if ($_POST['article_subject'] != "" && $_POST['article_body'] != "") {
			...
			$submit_info['article_snippet'] = stripinput($_POST['article_snippet']);
			$submit_info['article_body'] = stripinput($_POST['article_body']);
		...
		if (isset($_POST['preview_article'])) {
			...
			echo $locale['523']." ".stripslashes(nl2br(parsesmileys(parseubb($article_snippet))))."<br /><br />";
			echo $locale['524']." ".stripslashes(nl2br(parsesmileys(parseubb($article_body))));
			closetable();
		}
		if (!isset($_POST['preview_article'])) {
			$article_cat = "0";
	...
	if (isset($_POST['submit_download'])) {
		...
		if (dbrows($result)) {
			...
			echo "<input type='file' name='download_file' class='textbox' style='width:250px;' /><br />\n";
			...
			echo "<input type='file' name='download_image' class='textbox' style='width:250px;' /><br />\n";
