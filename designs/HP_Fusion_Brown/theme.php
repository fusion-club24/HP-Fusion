...
function render_page($license = false)
{
	...
	echo '<div id="top2" class="clearfix"><div class="member_area clearfix"><div class="member_area-text flright">';
		if (iMEMBER) {
			...
			echo "<a href='".BASEDIR."edit_profile.php'><img src='".DESIGN."images/hp_user-set.gif' alt='".$locale['hpfr_002']."' title='".$locale['hpfr_002']."' class='avatar-frame'   style='height: 35px; width: 35px;' /></a>&nbsp;&nbsp;";
			...
			if ($msg_count != 0) {
				...
				$icon_check = "hp_envelope-open.gif";
			} else {
				$msg_count_check = "";
				$icon_check = "hp_envelope-closed.gif";
			}
			...
			echo "<a class='navigation'  href='".BASEDIR."members.php'><img src='".DESIGN."images/hp_users_list.gif' alt='".$locale['global_122']."' title='".$locale['global_122']."' class='avatar-frame'   style='height: 35px; width: 35px;' /></a>&nbsp;";

			if (iADMIN && (iUSER_RIGHTS != "" || iUSER_RIGHTS != "C")) {
				echo "<a href='".ADMIN."index.php".$aidlink."'><img src='".DESIGN."images/hp_admin-2.gif' alt='".$locale['hpfr_004']."' title='".$locale['hpfr_004']."' class='avatar-frame'   style='height: 35px; width: 35px;' /></a>&nbsp;&nbsp;";
			}
			echo "<a class='navigation'  href='".BASEDIR."index.php?logout=yes'><img src='".DESIGN."images/hp_sign-out.gif' alt='".$locale['hpfr_005']."' title='".$locale['hpfr_005']."' class='avatar-frame'   style='height: 35px; width: 35px;' /></a>";
		} else {
			echo "<img src='".IMAGES."avatars/noavatar50.png' class='avatar-frame'  alt='' />";
			echo "<a href='".BASEDIR."login.php'><img src='".DESIGN."images/hp_sign-in.gif' alt='".$locale['hpfr_006']."' title='".$locale['hpfr_006']."' class='avatar-frame'   style='height: 35px; width: 35px;' /></a>";
					if ($settings['enable_registration']) {
			echo "<a href='".BASEDIR."register.php'><img src='".DESIGN."images/hp_address-card-o.gif' alt='".$locale['hpfr_007']."' title='".$locale['hpfr_007']."' class='avatar-frame'   style='height: 35px; width: 35px;' /></a>";
		}
