...
function render_menu(){
	...
	if (dbrows($msql) != 0) {
		echo "<div class='sub-header clearfix'><ul id='hp_top_menu'>";
						...
						if (checkgroup($mdata2['link_visibility'])) {
							...
							if (dbrows($msql4) != 0) {
								...
								if (strstr($mdata2['link_url'], "http://") || strstr($mdata2['link_url'], "https://")) {
									echo "<li class='submenu'><a href='".$mdata2['link_url']."'".$link_target."><span>".parseubb($mdata2['link_name'], "b|i|u|color|img")."</span> <img style='vertical-align:middle;' src='".MODULS."HP_side_navi_panel/images/sub_bg.gif' width='8' height='10' alt='Unterkategorie' title='Unterkategorie' /></a>\n";
								} else {
									echo "<li class='submenu'><a href='".BASEDIR.$mdata2['link_url']."'".$link_target."><span>".parseubb($mdata2['link_name'], "b|i|u|color|img")."</span> <img style='vertical-align:middle;' src='".MODULS."HP_side_navi_panel/images/sub_bg.gif' width='8' height='10' alt='Unterkategorie' title='Unterkategorie' /></a>\n";
								}
							} else {
								$link_target = ($mdata2['link_window'] == "1" ? " target='_blank'" : "");
								if (strstr($mdata2['link_url'], "http://") || strstr($mdata2['link_url'], "https://")) {
