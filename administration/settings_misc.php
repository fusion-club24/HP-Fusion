...
if (isset($_POST['savesettings'])) {
	$error = 0;
	$result = dbquery("UPDATE ".DB_SETTINGS." SET settings_value='".(isnum($_POST['bbcode_editor_enabled']) ? $_POST['bbcode_editor_enabled'] : "0")."' WHERE settings_name='bbcode_editor_enabled'");
	if (!$result) { $error = 1; }
...
echo "<td width='50%' class='tbl'><select name='bbcode_editor_enabled' class='textbox'>\n";
echo "<option value='1'".($settings['bbcode_editor_enabled'] == "1" ? " selected='selected'" : "").">".$locale['518']."</option>\n";
echo "<option value='0'".($settings['bbcode_editor_enabled'] == "0" ? " selected='selected'" : "").">".$locale['519']."</option>\n";
echo "</select></td>\n";
echo "</tr>\n<tr>\n";
