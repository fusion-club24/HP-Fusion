...
if (isset($_POST['savesettings'])) {
	...
	if (!$result) { $error = 1; }
	$result = dbquery("UPDATE ".DB_SETTINGS." SET settings_value='".stripinput($_POST['font_awe'])."' WHERE settings_name='font_awe'");
	if (!$result) { $error = 1; }
	$result = dbquery("UPDATE ".DB_SETTINGS." SET settings_value='".stripinput($_POST['font_et'])."' WHERE settings_name='font_et'");
	if (!$result) { $error = 1; }
...
$theme_files = makefilelist(DESIGNS, ".|..|templates", true, "folders");
...
echo "</tr>\n<tr>\n";
echo "<td width='30%' class='tbl'>".$locale['435']."</td>\n";
echo "<td width='70%' class='tbl'>";
	if ($settings2['site_database'] == "1") {
	echo "PDO";
	} else {
	echo "MySQL";
	}
...
if ($userdata['user_theme'] == "Default") {
  if ($settings2['theme'] != str_replace(DESIGNS, "", substr(DESIGN, 0, strlen(DESIGN)-1))) {
...
echo "</select></td>\n";
echo "</tr>\n<tr>\n";
echo "<td width='30%' class='tbl'>".$locale['436']."</td>\n";
echo "<td width='70%' class='tbl'><select id='font_awe' name='font_awe' class='textbox' style='width:100px;'>\n";
echo "<option value='0'".($settings2['font_awe'] == "0" ? " selected='selected'" : "").">".$locale['436a']."</option>\n";
echo "<option value='1'".($settings2['font_awe'] == "1" ? " selected='selected'" : "").">".$locale['436b']."</option>\n";
echo "</tr>\n<tr>\n";
echo "<td width='30%' class='tbl'>".$locale['437']."</td>\n";
echo "<td width='70%' class='tbl'><select id='font_et' name='font_et' class='textbox' style='width:100px;'>\n";
echo "<option value='0'".($settings2['font_et'] == "0" ? " selected='selected'" : "").">".$locale['436a']."</option>\n";
echo "<option value='1'".($settings2['font_et'] == "1" ? " selected='selected'" : "").">".$locale['436b']."</option>\n";
