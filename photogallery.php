...
//Photoalbum closed start
$set_photo_closed = dbarray(dbquery("SELECT settings_value FROM ".DB_SETTINGS." WHERE settings_name='photo_closed'"));
$set_ph_closed = $set_photo_closed['settings_value'];
$set_photo_closed_reason = dbarray(dbquery("SELECT settings_value FROM ".DB_SETTINGS." WHERE settings_name='photo_closed_reason'"));
$set_ph_closed_reason = $set_photo_closed_reason['settings_value'];

if ((!checkrights("PH")) && ($set_ph_closed == 1)) {
	...
	echo "<div align='center'>";
		...
		echo "".parsesmileys(parseubb(nl2br($set_ph_closed_reason)))."<br /><br />";
	echo "</div>\n";
	closetable();
