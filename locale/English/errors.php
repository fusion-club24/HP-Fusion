...
// Errorlog Management
$locale['err_100'] = "N/A";
$locale['err_101'] = "<strong>WARNING:</strong> An error occurred while parsing the page. Please see HP-Fusion's <a href='[ERROR_LOG_URL]' class='alt'>error log</a> for more details.";
?>