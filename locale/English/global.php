<?php
/*
English Language Fileset produced by Nick Jones (Digitanium)
*/
...
$locale['global_081']  = "Newsarea closed";
$locale['global_081a'] = "Articlesarea closed";
$locale['global_082']  = "Newsarea closed!";
$locale['global_082a'] = "Articlesarea closed!";
$locale['global_083']  = "Reason:";
...
$locale['global_101'] = "Name or Email";
...
$locale['global_196'] = "Invalid username/email or password.";
...
$locale['global_301'] = "We are really sorry but this page cannot be displayed. Due to some circumstances no site theme can be found. If you are a Site Administrator, please use your FTP client to upload any theme designed for <em>HP-Fusion</em> to the <em>themes/</em> folder. After upload check in <em>Main Settings</em> to see if the selected theme was correctly uploaded to your <em>themes/</em> directory. Please note that the uploaded theme folder has to have the exact same name (including character case, which is important on Unix based servers) as chosen in <em>Main Settings</em> page.<br /><br />If you are regular member of this site, please contact the site\'s administrator via ".hide_email($settings['siteemail'])." e-mail and report this issue.";
