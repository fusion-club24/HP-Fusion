...
$locale['404'] = "Delete all entries older than";
$locale['405'] = "days";
$locale['406'] = "Really delete all blacklist entries?";
$locale['407'] = "Delete";
$locale['408'] = "Delete all entries with reason StopForumSpam";
$locale['409'] = "Really delete all blacklist entries with reason StopForumSpam?";
$locale['410'] = "All entries with reason StopForumSpam have been deleted";
$locale['411'] = "(If 0, all entries are deleted.)";
...
<br /><br />
Entering an email address will prevent members from registering using that address.<br />
Entering an user name will prevent members from registering using that name.<br />
You can enter a full email address, e.g. <em>foo@bar.com</em>, or an email domain, e.g. <em>bar.com</em>.";
$locale['441'] = "Blacklist IP address:<br /><strong>or</strong>";
$locale['442'] = "Blacklist email address:<br /><strong>or</strong>";
$locale['443'] = "Blacklist reason";
$locale['444'] = "Blacklist save";
$locale['445'] = "Blacklist user";
