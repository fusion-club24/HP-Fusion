...
- Poll votes<br />
- Ratings given<br />
Unless this is a spammer for eg. we recommend you to Ban, Suspend or Cancel this user.<br />
<br />
Are you sure you want to delete this user?<br />";

$locale['425a'] = "<h2>Warning!</h2><br />
You are about to delete user <strong>%s</strong> !<br />
The following content <u>posted by this user</u> on this site will be anonymize if you proceed:<br />
- Articles<br />
- News<br />
- Forum threads.<br />
- Forum posts<br />
